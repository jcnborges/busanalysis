...
LINES = "/mnt/work/datalake/trusted/lines/year={0}/month={1:02d}/day={2:02d}"
...
file_lines = LINES.format(year, month, day)
...
parquet_files = glob.glob(join(file_lines, "*.parquet"))
data = [pd.read_parquet(f) for f in parquet_files]
